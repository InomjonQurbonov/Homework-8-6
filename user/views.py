...
from .models import PasswordResets, Contacts
from .permissons import IsOwnerOrSuperUser
from .serializers import UserSerializer, ProfileSerializer, ContactsSerializer, GetContactsSerializer
...
class ContactsViewSet(ModelViewSet):
    ...
    def get_serializer_class(self):
        if self.request.method == 'GET':
            return GetContactsSerializer
        return ContactsSerializer

    def perform_create(self, serializer):
        instance = serializer.save()
        self.send_admin_email(instance)

    def send_admin_email(self, instance):
        send_mail(
